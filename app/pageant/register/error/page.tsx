...
export default function RegistrationErrorPage({
  ...
  const errorMessage = (searchParams.message as string) || "An error occurred while processing your registration."

  return (
    <div className="flex flex-col w-full">
      <PageHeader title="Registration Error" description="There was a problem with your application" />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-playfair text-3xl md:text-4xl font-bold text-[#212224] mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                <Button asChild className="bg-[#212224] hover:bg-[#212224]/90">
                  <Link href="/pageant/register">Try Again</Link>
                </Button>
